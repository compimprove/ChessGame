...
const BoardIcon = <svg width="51" height="51" viewBox="0 0 51 51" xmlns="http://www.w3.org/2000/svg">
...
export function UserThinking({ name }) {
    return <div className='user-normal'>
        <img style={{ width: "3.8em" }} src='./svg/loading.svg' />
        <span>{name}</span>
    </div>
}
...
export function UserWaiting() {
    return <div className='user-normal'>
    <img style={{ width: "3.8em" }} src='./svg/time.svg' />
